...
- ****¿Qué es el cómputo en la nube?****
    ...
    ![Untitled](Curso%20Pra%CC%81ctico%20de%20AWS%2024475480c49a4f56b305349b6a8e131b/Untitled.png)
...
- ****Subiendo un proyecto: Clonando un repositorio de GitHub a nuestra Instancia de EC2****
    ...
    <aside>
    👉 **Nota**: Antes de comenzar, asegúrate de tener una instancia de EC2 creada y configurada. También debes tener acceso a tu cuenta de GitHub y a la consola de administración de AWS.
...
- ****¿Qué es Lambda y Serverless?****
    ...
    ![Untitled](Curso%20Pra%CC%81ctico%20de%20AWS%2024475480c49a4f56b305349b6a8e131b/Untitled%201.png)
    
    ![Untitled](Curso%20Pra%CC%81ctico%20de%20AWS%2024475480c49a4f56b305349b6a8e131b/Untitled%202.png)
    
    ![Untitled](Curso%20Pra%CC%81ctico%20de%20AWS%2024475480c49a4f56b305349b6a8e131b/Untitled%203.png)
    ...
    - Notas personales:
        ...
        Lambda y Serverless son dos conceptos relacionados que se utilizan en el contexto de la computación en la nube.
        
        AWS Lambda es un servicio de cómputo sin servidor ofrecido por Amazon Web Services (AWS). Proporciona una forma de ejecutar código sin la necesidad de aprovisionar ni administrar servidores. En lugar de preocuparte por la infraestructura subyacente, Lambda te permite centrarte en escribir y ejecutar tu código de manera eficiente. Puedes utilizar Lambda para ejecutar código en respuesta a eventos, como cambios en los datos de Amazon S3, actualizaciones de registros en Amazon CloudWatch o solicitudes HTTP recibidas mediante Amazon API Gateway.
        
        El concepto de "serverless" (sin servidor) se refiere a un modelo de programación en el que los desarrolladores pueden escribir y ejecutar aplicaciones sin preocuparse por los servidores subyacentes. En lugar de administrar servidores o máquinas virtuales, el proveedor de servicios en la nube (como AWS) se encarga de la administración de la infraestructura, el escalado automático y la disponibilidad. El término "sin servidor" no significa que no haya servidores en absoluto, sino que el desarrollador no tiene que preocuparse por ellos directamente.
        
        Al adoptar el enfoque serverless y utilizar servicios como AWS Lambda, puedes reducir la carga operativa y los costos asociados con la administración de servidores. Puedes enfocarte en el desarrollo de tu aplicación y aprovechar la escalabilidad automática que ofrecen estos servicios. Además, pagas solo por el tiempo de ejecución de tu código, lo que permite un uso más eficiente de los recursos.
        
        Lenguajes admitidos: AWS Lambda admite varios lenguajes de programación, como Python, Node.js, Java, C#, Go, Ruby y otros. Esto brinda a los desarrolladores la flexibilidad de elegir el lenguaje que mejor se adapte a sus necesidades y habilidades.
